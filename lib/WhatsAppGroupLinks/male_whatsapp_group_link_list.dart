...
import 'male_whatsapp_group_link.dart';

class MaleWhatsAppGroupLinkList extends ChangeNotifier {
  List<MaleWhatsAppGroupLink> _whatsAppGroupLinks = [
//    Cricket Groups
  ...
  List<MaleWhatsAppGroupLink> get whatsAppGroupLinks {
